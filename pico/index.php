...
<head>
  ...
  <title>MEDLINE/PubMed via PICO</title>
...
<script>
  function onSubmit(token) {
    document.getElementById("frmQueryBox").submit();
  }
</script>
</head>
...
<form enctype="application/x-www-form-urlencoded" name="frmQueryBox" id="frmQueryBox"
action=<?php echo $_SERVER['PHP_SELF']."?proj=$proj&lang=$lang"; ?> method="POST">

<b>Search MEDLINE/PubMed via PICO with Spelling Checker</b>
<br>
<font size ="2"><i>Patient, Intervention, Comparison, Outcome</i></font>
<hr/>
<table cellpadding="2" cellspacing="2">
<tr><td colspan="2">
<b><font size="3">P</font></b>atient/<b>P</b>roblem:
</td></tr>
<tr><td>
<font size="3"><b>M</b>edical condition:</font>
</td><td>
<input type="text" name="condition" id="condition" size="20" />
<br>
</td></tr>
<tr><td>
<font size="3"><b>I</b>ntervention:</font> 
<br><font size="2">(therapy, diagnostic test, etc.)</font>
</td><td>
<input type="text" name="intervention" id="intervention" size="20" />
<br>
</td></tr>
<tr><td>
<font size="3"><b>C</b>ompare to:</font>
<br>
<font size="2">(same as above, optional):</font>
</td><td> 
<input type="text" name="comparison" id="comparison" size="20" />
<br>
</td></tr>
<tr><td>
<font size="3"><b>O</b>utcome: </font><br>
<font size="2">(optional)</font>
</td><td>
<input type="text" name="outcome" id="outcome" size="20" />
</td></tr>
</table>
<hr / width=50% align=left>
<font size="3">Select Publication type:<br /></font> 
<select name="pubtype">
<option value="0">Not specified</option>
<option value="1">Clinical Trial</option>
<option value="2">Meta-Analysis</option>
<option value="3">Randomized Controlled Trial</option>
<option value="4">Systematic Reviews</option>
...
<?php
  ...
  $question[3] = str_replace($vowels, " ", $_POST["comparison"]);
  $question[4] = str_replace($vowels, " ", $_POST["outcome"]);
			
  $espell = new espell();
  $corr = array();
  $false = array();
  for ($qi = 1; $qi<=4; $qi++) {
    $espell->getSpell($question[$qi]);
...
<form enctype="application/x-www-form-urlencoded" name="query2" action="search.php?hand=tbldt&fromgs=1&proj=<?php echo $proj."&lang=$lang";?>" method="POST">
  <input type="hidden" value=<?php echo "\"".$_POST["condition"]."\""; ?> name="condition">
  <input type="hidden" value=<?php echo "\"".$_POST["intervention"]."\""; ?> name="intervention">
  <input type="hidden" value=<?php echo "\"".$_POST["comparison"]."\""; ?> name="comparison">
  <input type="hidden" value=<?php echo "\"".$_POST["outcome"]."\""; ?> name="outcome">
...
<form enctype="application/x-www-form-urlencoded" name="frmQueryBox" 
action="search.php?hand=tbldt&fromgs=2&proj=<?php echo $proj."&lang=$lang";?>" method="post">

<b>Search MEDLINE/PubMed via PICO with Spelling Checker</b><br>
<font size ="2">
<i>Patient, Intervention, Comparison, Outcome</i>
</font>
<hr/>
<table cellpadding="2" cellspacing="2" >
<tr><td colspan="2">
<b><font size="3">P</font></b>atient/<b>P</b>roblem:</font> 
</td>
</tr>
<tr>
<td>
<font size="3"><b>M</b>edical
condition:</font></td> <td><input type="text" name="condition" 
id="condition" value=<?php echo "\"".$_POST["condition"]."\""; ?> size="20" >
<br>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="intervention" id="intervention" value=<?php echo "\"".$_POST["intervention"]."\""; ?> size="20" />
<br>
</td>
</tr>
<tr>
<td>
<font size="3"><b>C</b>ompare to:</font>
<br><font size="2">(same as above, optional):</font>
</td><td> 
<input type="text" name="comparison" id="comparison" value=<?php echo "\"".$_POST["comparison"]."\""; ?>  size="20" />
<br>
</td>
</tr>
<tr>
...
<td>
<input type="text" name="outcome" id="outcome" value=<?php echo "\"".$_POST["outcome"]."\""; ?>   size="20" /></font>
</td>
</tr>
</table>
<hr / width=50% align=left>
...
<?php
$fname[1]= "condition";
$fname[2]= "intervention";
$fname[3]= "comparison";
$fname[4]= "outcome";
	
$ftag[1]= "Medical Condition:";
$ftag[2]= "Intervention:";
$ftag[3]= "Compare to:";
$ftag[4]= "Outcome:";
for ($qi=1; $qi<=4; $qi++) {
  if (trim($question[$qi]) !='') {	    
    if ($false[$qi] == 1) {
      ...
      if ($corr[$qi] !='') {
        echo "<font size=2>";
	echo "<input type=button value=\"".$corr[$qi]."\" ";
	echo "onClick=\"document.getElementById('".$fname[$qi]."').value ='".$corr[$qi]."';\"> ";
	echo "</font>";
      }	
      echo "<p>";
    } // end if $false  
...
<font size="3"><input type="submit" value="Submit" />&nbsp;
<input type = "button" value = "Clear" 
	Onclick="document.frmQueryBox.checked.value=''; document.frmQueryBox.action='<?php echo $_SERVER['PHP_SELF']; ?>'; document.frmQueryBox.submit();">
</font>
</form>
