...
<head>
  ...
  <title>Consensus Abstracts PICO</title>
...
<?php
  ...
  $checked = array_key_exists('checked', $_POST)? $_POST["checked"] : '';
	...
	$outid = array_key_exists('outid', $_GET)? $_GET['outid'] : '';
	$proj = array_key_exists('proj', $_GET)? $_GET['proj'] : '';
	$lang = array_key_exists('lang', $_GET)? $_GET['lang'] : '';
	$t = array_key_exists('t', $_GET)? $_GET['t'] : '';
	
	if ($outid == '') {
	  $outid = array_key_exists('outid', $_POST)? $_POST['outid']:'';
	}
...
name="frmQueryBox" id="frmQueryBox" action=<?php echo $_SERVER['PHP_SELF']."?outid=$outid&lang=$lang&proj=$proj&t=$t"; ?> method="post">
<font size="3"><b>Search MEDLINE/PubMed via PICO</b></font>
...
<tr><td colspan="2">
<b><font size="3">P</font></b><font
size="3">atient/<b>P</b>roblem:</font> 

</td></tr>
<tr><td colspan="2">

<font size="3">Medical
condition:</font> <input type="text" name="condition"
size="20" />
<br>
...
<input type="text"name="intervention" size="20" />
<br>
...
<input type="text" name="comparison" size="20" />
<br>
...
<input type="text" name="outcome" size="20" /></font>

</td></tr>
</table>

<hr />
<font size="3"><font size="3"><font size="3">Select Publication
type:<br />
</font> <select name="pubtype">
<option value="0">Not specifiied</option>
<option value="1">Clinical Trial</option>
<option value="2">Meta-Analysis</option>
<option value="3">Randomized Controlled Trial</option>
<option value="4">Systematic Reviews (or Reviews)</option>
...
<?php
  ...
  elseif ($_POST["checked"] == 1){
    	...
    	$question[1] = str_replace($vowels, " ", $_POST["condition"]);
  		...
  		if ($checked == 1) {
?>
<form enctype="application/x-www-form-urlencoded" name="query2" action="consensus_search.php?&fromgs=1&outid=<?php echo $outid."&lang=$lang&proj=$proj&t=$t"; ?>" method="POST">
...
<basefont face="arial" size="3" />  
<form enctype="application/x-www-form-urlencoded"
name="frmQueryBox" id="frmQueryBox" action="consensus_search.php?&fromgs=1&outid=<?php echo $outid."&lang=$lang&proj=$proj&t=$t"; ?>" method="post"><font
size="3"><b>Search MEDLINE/PubMed via PICO</b></font><br>
<font size ="2">
...
<font size="3">Medical
condition:</font> <input type="text" name="condition" id="condition" value=<?php echo "\"".$_POST["condition"]."\""; ?>
size="20" />
<br>
...
<input type = "button" value = "Clear" 
	Onclick="document.frmQueryBox.checked.value=''; document.frmQueryBox.action='<?php echo $_SERVER['PHP_SELF']."?outid=$outid&lang=$lang&proj=$proj"; ?>'; document.frmQueryBox.submit();">
